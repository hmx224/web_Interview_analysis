最近社区里面有一篇文章引起了最多程序猿的关注，分享一下 Laravel、PHPer 面试可能会遇到的问题，看评论区不少小伙伴们被难倒，对于一些问题同样难倒了我（其实有很多啦），趁着周末有空，又总结梳理了一遍，顺便来答一波题。由于个人技术水平有限，答案或许会有偏差，欢迎大家指正。
...
服务器集群搭建、负载均衡、反向代理
服务器常用命令
PS: PHPer 面试关注的技术实力仅仅只是一部分，还有一部分会关注你的内驱力、思考力以及表达能力。其实关注最多的是你是否是妹子、你的颜值还有你是否单身！！！  joy
